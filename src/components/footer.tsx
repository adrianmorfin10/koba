        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#productos" className="text-gray-300 hover:text-[#FF4646] transition-colors flex items-center">
                  <span className="mr-2">•</span> Productos
                </a>
              </li>
              <li>
                <a href="#nosotros" className="text-gray-300 hover:text-[#FF4646] transition-colors flex items-center">
                  <span className="mr-2">•</span> Nosotros
                </a>
              </li>
              <li>
                <a href="#contacto" className="text-gray-300 hover:text-[#FF4646] transition-colors flex items-center">
